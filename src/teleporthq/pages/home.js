...
const Home = (props) => {
  return (
    <div className="home-container">
      ...
      <img
        alt="image"
        src="/playground_assets/curved6.jpg"
      ...
      <section className="home-features">
        ...
        <FeatureCard
          ...
          image_src="/playground_assets/credit card1.svg"
        ></FeatureCard>
      </section>
          ...
          <div className="home-container13">
            <div className="home-container14">
              ...
              <div className="home-container15">
                <img
                  alt="image"
                  src="/playground_assets/team-4.jpg"
                  className="home-image08"
                />
                <div className="home-container16"></div>
                <img
                  alt="image"
                  src="/playground_assets/team-3.jpg"
                  className="home-image09"
                />
                <div className="home-container17"></div>
                <img
                  alt="image"
                  src="/playground_assets/team-2.jpg"
